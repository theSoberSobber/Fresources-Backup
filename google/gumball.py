...
from test import upload, checkFolder, checkNCreateDrive, getFolderId, getResourceId, getResourceLink
    ...
    try:
        for i in collegeIds :
            ...
            for j in resB:
                ...
                upload(f"{j['name']}.json", f"./data/{i}/{j['name']}/{j['name']}.json", branchFolderId)
